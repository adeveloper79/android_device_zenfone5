...
TARGET_PREBUILT_KERNEL := device/asus/ASUS_T00F/kernel-ww-2.20.40.13
...
# Recovery
TARGET_RECOVERY_FSTAB := device/asus/ASUS_T00F/ramdisk/recovery.fstab
TARGET_RECOVERY_INITRC := device/asus/ASUS_T00F/ramdisk/recovery.init.redhookbay.rc
TARGET_RECOVERY_PIXEL_FORMAT := "BGRA_8888"
TARGET_RECOVERY_SCREEN_WIDTH := 720
TARGET_PREBUILT_RECOVERY_KERNEL := device/asus/ASUS_T00F/kernel-ww-2.20.40.13
...
BOARD_EGL_CFG := device/asus/ASUS_T00F/configs/egl.cfg
...
# SELinux
HAVE_SELINUX := true
BOARD_SEPOLICY_DIRS += device/asus/ASUS_T00F/sepolicy
